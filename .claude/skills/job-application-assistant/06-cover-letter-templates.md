...
%     TITLE NAME
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{}{\Huge{Amir Pournasserian}}{  \href{mailto:amir.pournasserian@live.com}{amir.pournasserian@live.com} | +1 647 937 1601 |  \urlstyle{same}\href{https://www.linkedin.com/in/pournasserian}{LinkedIn}
}
